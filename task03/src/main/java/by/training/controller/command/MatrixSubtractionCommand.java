 ...
 *
 */
public class MatrixSubtractionCommand<T extends Number> implements Command {

	private static final Logger LOG = LogManager.getLogger(MatrixSubtractionCommand.class);
	...
	public String execute(String[] request) {
		...
		try {
			...
			// calculate result of their subtraction
			MatrixCalculation calc = provider.getMatrixCalculation();
			Matrix<BigDecimal> result = calc.matrixSubtraction(firstMatrix, secondMatrix);
		...
		return "0___matrix_subtraction_success";
