 ...
 *
 */
public class MatrixAdditionCommand<T extends Number> implements Command {

	private static final Logger LOG = LogManager.getLogger(MatrixAdditionCommand.class);
	...
	public String execute(String[] request) {
		...
		try {
			...
			// calculate their summ
			MatrixCalculation calc = provider.getMatrixCalculation();
			Matrix<BigDecimal> result = calc.matrixAddition(firstMatrix, secondMatrix);
		...
		return "0___matrix_addition_success";
