...
import by.training.task05.repository.specification.find.CoordinateBeginingRangeFindSpecification;
import by.training.task05.service.ServiceException;

public class SpecificationBegginingRangeCreator implements SpecificationCreator {

    private static final Logger LOG = LogManager
	    .getLogger(SpecificationBegginingRangeCreator.class);
	...
	CoordinateBeginingRangeFindSpecification result = new CoordinateBeginingRangeFindSpecification(
		min, max);
