...
import by.training.task05.repository.specification.find.CoordinateZRangeFindSpecidication;
 ...
 * 
 */
public class SpecificationZRangeCreator implements SpecificationCreator {

    private static final Logger LOG = LogManager.getLogger(SpecificationZRangeCreator.class);

    /**
     * 
     * create CoordinateZRangeFindSpecidication from string
     * 
	...
	CoordinateZRangeFindSpecidication result = new CoordinateZRangeFindSpecidication(min, max);
