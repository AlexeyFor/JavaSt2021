 ...
 *
 */
public class ExpressionRightShiftZeroAppear implements AbstractExpression {

    private static final Logger LOG = LogManager.getLogger(ExpressionRightShiftZeroAppear.class);
